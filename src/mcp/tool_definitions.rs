                                    ...
                                    "pads": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                ...
                                                "per_layer_shapes": { "type": "array", "description": "Per-layer pad shapes, same ordering and count as per_layer_sizes.", "items": { "type": "string", "enum": ["round", "rectangular", "octagonal", "rounded_rectangle"] } },
            ...
            ToolDefinition {
                ...
                description: Some(
                    "Export an Altium library to JSON or CSV format for version control, backup, \
                     ...
                     table of component names and basic info."
                        .to_string(),
                ),
                input_schema: json!({
                    "type": "object",
