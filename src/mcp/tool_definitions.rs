                ...
                "pads": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "per_layer_corner_radii": { "type": "array", "description": "Per-layer corner radius as a whole-number percentage (0-100) for rounded-rectangle layers; \"full_stack\" only, 32 entries.", "items": { "type": "integer" } },
                            ...
                            "corner_radius_percent": { "type": "integer", "description": "Rounded-rectangle corner radius as a whole-number percentage of the shorter side (0-100; anything else is refused). Default: 0" },
